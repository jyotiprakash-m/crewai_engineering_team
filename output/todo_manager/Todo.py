...
A simple Todo management module implementing CRUD operations for tasks.
...
- update_task(task_id, title=None, description=None, status=None) -> None
- delete_task(task_id) -> None
- list_tasks() -> list

This module is self-contained and does not provide any UI.
"""
